...
template <typename T> constexpr T IE_Max(T a, T b)
{
    return a < b ? b : a;
}

template <typename T> constexpr T IE_Min(T a, T b)
{
    return a < b ? a : b;
}

template <typename T> constexpr T IE_Fabs(T value)
{
    return std::fabs(value);
}

template <typename T> constexpr T IE_Sqrt(T value)
{
    return std::sqrt(value);
}

inline f32 IE_Sinf(f32 value)
{
    return std::sin(value);
}

inline f32 IE_Cosf(f32 value)
{
    return std::cos(value);
}

template <typename T> constexpr bool IE_IsFinite(T value)
{
